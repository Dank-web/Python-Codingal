...
#Function to display a messsage
def display():
...
#Press button, display function will be called automaticallly
btn = Button(text="Begin", command=display, height=1, bg="#5EDD8F", fg="white")
